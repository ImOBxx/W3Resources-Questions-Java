...
public class Exercise173 {
	...
	private static void remove(PriorityQueue<Integer> right_num, PriorityQueue<Integer> left_num, int i) {
	...
	private static int compute_median(PriorityQueue<Integer> right_num, PriorityQueue<Integer> left_num) {
		...
		while (left_num.size() < right_num_size()) {
			left_num.add(right_num.poll());
		}
		return left_num.peek();
	}
	private static int right_num_size() {
		// TODO Auto-generated method stub
		return 0;
	}
